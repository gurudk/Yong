import numpy as np
from dlf.dezero import cuda
from dlf.dezero.core import Function, as_variable
from dlf.dezero.utils import pair, get_conv_outsize, get_deconv_outsize
from dlf.dezero.functions import linear, broadcast_to
