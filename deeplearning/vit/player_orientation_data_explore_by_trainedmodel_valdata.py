...
test_model_file = "./zoo/transformer/player_resnet18_140.torch"
LOG_FILE = "./log/train.log." + get_nowtime_str()
player_body_orientation_data_explored_file = "./explored/player_body_orientation_data_explored_file_140pth_angle_valdata.txt." + get_nowtime_str()
validation_rate = .1
