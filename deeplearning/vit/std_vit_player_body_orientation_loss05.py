...
val_json_file = "./player_annotation/new_data_loss05_mergeall_val_data_07.json.20240928093915"

LOG_FILE = "./log/train_new_data_loss05.log." + get_nowtime_str()
validation_rate = .1
...
for epoch in trange(TOTAL_EPOCHS + 1, desc="Training.."):  # Training loop
    ...
    if epoch % 20 == 0:  # Save model
        ...
        torch.save(model.state_dict(), "./zoo/new_data_loss05_with_val05_" + str(epoch) + ".torch")
