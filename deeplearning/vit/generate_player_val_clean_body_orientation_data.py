...
PLAYER_TRAIN_DIR = "/home/wolf/datasets/DFL/clean_body_orientation_atan2_val_07/"
...
player_annotated_file = "./player_annotation/clean_body_orientation_atan2_val_07.json." + nowtime.strftime(
    "%Y%m%d%H%M%S")
