...
class SoccerViT(nn.Module):
    def __init__(self, chw, n_patches=40, n_blocks=6, hidden_d=256, n_heads=8, out_d=2):
        # Super constructor
...
def main():
    ...
    model = SoccerViT(
        (3, 360, 640), n_patches=40, n_blocks=6, hidden_d=256, n_heads=8, out_d=2
    ).to(device)
    ...
    torch.save(model, 'soccer_vit_500_L1loss.pth')
