...
BATCH_SIZE = 1
AVG_BATCH_SIZE = 50
full_dataset_file = "./player_annotation/clean_body_orientation_loss25_mergeall_07.json.20240928093915"
test_model_file = "model/loss15/cleandata_loss15_16x16_160.torch"
LOG_FILE = "./log/train.log." + get_nowtime_str()
player_body_orientation_data_explored_file = "./explored/new_explore_140th.txt." + get_nowtime_str()
validation_rate = 0
