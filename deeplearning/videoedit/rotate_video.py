...
cap = cv2.VideoCapture('/home/wolf/datasets/xueshifootball/xueshi.mp4')
...
newvideoR = cv2.VideoWriter('/home/wolf/datasets/xueshifootball/xueshi_new.mp4', cv2.VideoWriter_fourcc(*"mp4v"), 25,
...
for i in range(frame_number):
    ...
    new = cv2.rotate(frame, cv2.ROTATE_llllllllll90_COUNTERCLOCKWISE)
