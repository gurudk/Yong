...
trainer.save_checkpoint("my_first_balloon_model.ckpt")

# model.model.push_to_hub("gurudk/my-detr-finetuned-balloon-v2")
# processor.push_to_hub("gurudk/my-detr-finetuned-balloon-v2")
