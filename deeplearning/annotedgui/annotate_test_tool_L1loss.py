...
class MainWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        self.model = torch.load('soccer_vit_150_L1loss.pth')
    ...
    def draw_predict_and_truth(self):
        ...
        y_hat_tpl = torch.tensor([1280, 720], device=self.device)
        image_coord_hat = (y_hat_tpl * y_hat_coord.squeeze()).to(dtype=int)
        ...
        painter.drawRect(image_coord_hat[0] - 64, image_coord_hat[1] - 54, 128, 108)
