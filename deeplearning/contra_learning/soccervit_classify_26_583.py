...
TOTAL_EPOCHS = 500
BATCH_SIZE = 128
full_dataset_file = "/home/wolf/datasets/reid/dataset/classify/player_classify_span3.json.20241107152949"
...
for epoch in trange(TOTAL_EPOCHS + 1, desc="Training.."):  # Training loop
    ...
    if epoch % 10 == 0 and epoch != 0:
        ...
        torch.save(model.state_dict(), "./zoo/classify_vit/vit_classify_26_583_" + str(latest_epoch) + ".torch")
