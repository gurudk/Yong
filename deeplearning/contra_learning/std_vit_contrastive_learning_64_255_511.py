...
SUB_BATCH_SIZE = 16
AVG_BATCH_SIZE = 50
train_json_file = "/home/wolf/datasets/reid/dataset/final_dataset.json.20241023152537"

LOG_FILE = "./log/std_soccer_vit_cl_64_255_511.log." + get_nowtime_str()
validation_rate = .1
...
for epoch in trange(TOTAL_EPOCHS + 1, desc="Training.."):  # Training loop
    ...
    torch.save(model.state_dict(), "./zoo/std_soccer_vit_cl_64_256_511_" + str(epoch) + ".torch")
