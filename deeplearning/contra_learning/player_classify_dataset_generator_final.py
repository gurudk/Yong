...
dump_json_file = "/home/wolf/datasets/reid/dataset/classify/train_classify_minnum20_span3.json." + get_nowtime_str()
...
sample5_json = sample_players(sample5_json, frame_span=3)
#
