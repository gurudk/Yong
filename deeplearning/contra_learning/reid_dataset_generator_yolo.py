...
# Open the video file
video_path = "/home/wolf/datasets/xueshifootball/no_sound_clips/xueshi_new_211.mp4"
...
while cap.isOpened():
    ...
    if success:
        ...
        for box, track_id, conf in zip(boxes, track_ids, confs):
            ...
            player_path = reid_dataset_path.joinpath(video_file_stem).joinpath(video_file_stem + "_" + str(track_id))
